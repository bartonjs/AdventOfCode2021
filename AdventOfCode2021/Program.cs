...
namespace AdventOfCode2021
{
    internal class Program
    {
        ...
        {
#if SAMPLE
            string filename = $"Day{day}_sample.txt";
#else
        ...
        private static MethodInfo GetTarget(string[] args, out int day)
        {
            ...
            if (args?.Length > 0)
            {
                ...
                Type t = typeof(Program).Assembly.GetType($"{rootNS}.Solutions.Day{day}", true);
            ...
            for (int i = 25; i > 0; i--)
            {
                Type t = typeof(Program).Assembly.GetType($"{rootNS}.Solutions.Day{i}", false);
